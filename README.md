...
**Claude Code** — `claude plugin install syntaqlite` ([docs](https://docs.syntaqlite.com/main/getting-started/claude-code/)) · **Claude Desktop / Cursor / Windsurf** — `syntaqlite mcp` ([docs](https://docs.syntaqlite.com/main/getting-started/mcp/))
