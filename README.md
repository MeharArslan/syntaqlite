...
**Claude Code** — `claude plugin install syntaqlite@LalitMaganti/claude-code-plugin` ([docs](https://docs.syntaqlite.com/main/getting-started/claude-code/)) · **Claude Desktop / Cursor / Windsurf** — `syntaqlite mcp` ([docs](https://docs.syntaqlite.com/main/getting-started/mcp/))
...
```toml
[dependencies]
syntaqlite = { version = "0.0.32", features = ["fmt"] }
```
