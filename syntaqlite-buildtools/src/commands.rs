...
use crate::codegen_api::{
    CodegenRequest, DialectCodegenJob, DialectNaming, AUTOGENERATED_MARKER,
...
impl SqliteCodegen {
    ...
    pub fn run(&self) -> Result<(), String> {
        ...
        let shared_include_dir = Path::new(SQLITE_SHARED_CRATE)
            .join(format!("include/{}", dialect.include_dir_name()));
...
fn generate_ast_traits(actions_dir: &str, nodes_dir: &str) -> Result<(), String> {
    ...
    fs::write(out, ast_traits_content)
...
impl SqliteExtract {
    ...
    pub fn run(&self) -> Result<(), String> {
        ...
        let cflags =
            crate::extract::keywords_and_parser::extract_keyword_cflags(&mkkeywordhash_c)?;
