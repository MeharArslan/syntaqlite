...
mod codegen_api {
    ...
    pub const AUTOGENERATED_MARKER: &str = crate::pipeline::writers::c_writer::AUTOGENERATED_MARKER;

    use crate::*;
    use crate::pipeline::{grammar_codegen, keyword_hash, parser_pipeline, sqlite_fragments, tokenizer_assembly, tools};
