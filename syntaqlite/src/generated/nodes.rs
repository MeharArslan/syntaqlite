...
use syntaqlite_runtime::{FieldDescriptor, FieldKind, Fields, NodeId, NodeList, SourceSpan};
...
impl<'a> Node<'a> {
    ...
    /// Return a raw pointer to the inner struct data.
    pub(crate) fn as_ptr(&self) -> *const u8 {
        match self {
            Node::AggregateFunctionCall(n) => *n as *const AggregateFunctionCall as *const u8,
            Node::CastExpr(n) => *n as *const CastExpr as *const u8,
            Node::ColumnRef(n) => *n as *const ColumnRef as *const u8,
            Node::CompoundSelect(n) => *n as *const CompoundSelect as *const u8,
            Node::SubqueryExpr(n) => *n as *const SubqueryExpr as *const u8,
            Node::ExistsExpr(n) => *n as *const ExistsExpr as *const u8,
            Node::InExpr(n) => *n as *const InExpr as *const u8,
            Node::IsExpr(n) => *n as *const IsExpr as *const u8,
            Node::BetweenExpr(n) => *n as *const BetweenExpr as *const u8,
            Node::LikeExpr(n) => *n as *const LikeExpr as *const u8,
            Node::CaseExpr(n) => *n as *const CaseExpr as *const u8,
            Node::CaseWhen(n) => *n as *const CaseWhen as *const u8,
            Node::CaseWhenList(l) => *l as *const NodeList as *const u8,
            Node::ForeignKeyClause(n) => *n as *const ForeignKeyClause as *const u8,
            Node::ColumnConstraint(n) => *n as *const ColumnConstraint as *const u8,
            Node::ColumnConstraintList(l) => *l as *const NodeList as *const u8,
            Node::ColumnDef(n) => *n as *const ColumnDef as *const u8,
            Node::ColumnDefList(l) => *l as *const NodeList as *const u8,
            Node::TableConstraint(n) => *n as *const TableConstraint as *const u8,
            Node::TableConstraintList(l) => *l as *const NodeList as *const u8,
            Node::CreateTableStmt(n) => *n as *const CreateTableStmt as *const u8,
            Node::CteDefinition(n) => *n as *const CteDefinition as *const u8,
            Node::CteList(l) => *l as *const NodeList as *const u8,
            Node::WithClause(n) => *n as *const WithClause as *const u8,
            Node::DeleteStmt(n) => *n as *const DeleteStmt as *const u8,
            Node::SetClause(n) => *n as *const SetClause as *const u8,
            Node::SetClauseList(l) => *l as *const NodeList as *const u8,
            Node::UpdateStmt(n) => *n as *const UpdateStmt as *const u8,
            Node::InsertStmt(n) => *n as *const InsertStmt as *const u8,
            Node::BinaryExpr(n) => *n as *const BinaryExpr as *const u8,
            Node::UnaryExpr(n) => *n as *const UnaryExpr as *const u8,
            Node::Literal(n) => *n as *const Literal as *const u8,
            Node::ExprList(l) => *l as *const NodeList as *const u8,
            Node::FunctionCall(n) => *n as *const FunctionCall as *const u8,
            Node::Variable(n) => *n as *const Variable as *const u8,
            Node::CollateExpr(n) => *n as *const CollateExpr as *const u8,
            Node::RaiseExpr(n) => *n as *const RaiseExpr as *const u8,
            Node::QualifiedName(n) => *n as *const QualifiedName as *const u8,
            Node::DropStmt(n) => *n as *const DropStmt as *const u8,
            Node::AlterTableStmt(n) => *n as *const AlterTableStmt as *const u8,
            Node::TransactionStmt(n) => *n as *const TransactionStmt as *const u8,
            Node::SavepointStmt(n) => *n as *const SavepointStmt as *const u8,
            Node::ResultColumn(n) => *n as *const ResultColumn as *const u8,
            Node::ResultColumnList(l) => *l as *const NodeList as *const u8,
            Node::SelectStmt(n) => *n as *const SelectStmt as *const u8,
            Node::OrderingTerm(n) => *n as *const OrderingTerm as *const u8,
            Node::OrderByList(l) => *l as *const NodeList as *const u8,
            Node::LimitClause(n) => *n as *const LimitClause as *const u8,
            Node::TableRef(n) => *n as *const TableRef as *const u8,
            Node::SubqueryTableSource(n) => *n as *const SubqueryTableSource as *const u8,
            Node::JoinClause(n) => *n as *const JoinClause as *const u8,
            Node::JoinPrefix(n) => *n as *const JoinPrefix as *const u8,
            Node::TriggerEvent(n) => *n as *const TriggerEvent as *const u8,
            Node::TriggerCmdList(l) => *l as *const NodeList as *const u8,
            Node::CreateTriggerStmt(n) => *n as *const CreateTriggerStmt as *const u8,
            Node::CreateVirtualTableStmt(n) => *n as *const CreateVirtualTableStmt as *const u8,
            Node::PragmaStmt(n) => *n as *const PragmaStmt as *const u8,
            Node::AnalyzeStmt(n) => *n as *const AnalyzeStmt as *const u8,
            Node::AttachStmt(n) => *n as *const AttachStmt as *const u8,
            Node::DetachStmt(n) => *n as *const DetachStmt as *const u8,
            Node::VacuumStmt(n) => *n as *const VacuumStmt as *const u8,
            Node::ExplainStmt(n) => *n as *const ExplainStmt as *const u8,
            Node::CreateIndexStmt(n) => *n as *const CreateIndexStmt as *const u8,
            Node::CreateViewStmt(n) => *n as *const CreateViewStmt as *const u8,
            Node::ValuesRowList(l) => *l as *const NodeList as *const u8,
            Node::ValuesClause(n) => *n as *const ValuesClause as *const u8,
            Node::FrameBound(n) => *n as *const FrameBound as *const u8,
            Node::FrameSpec(n) => *n as *const FrameSpec as *const u8,
            Node::WindowDef(n) => *n as *const WindowDef as *const u8,
            Node::WindowDefList(l) => *l as *const NodeList as *const u8,
            Node::NamedWindowDef(n) => *n as *const NamedWindowDef as *const u8,
            Node::NamedWindowDefList(l) => *l as *const NodeList as *const u8,
            Node::FilterOver(n) => *n as *const FilterOver as *const u8,
            Node::__Phantom(_) => unreachable!(),
        }
    }

    /// Extract all fields into a returned `Fields` value.
    pub fn fields(&self, source: &'a str) -> Fields<'a> {
        let descriptors = FIELD_DESCRIPTORS[self.tag() as usize];
        let ptr = self.as_ptr();
...
const FIELDS_AGGREGATE_FUNCTION_CALL: &[FieldDescriptor] = &[
    ...
    FieldDescriptor { offset: offset_of!(AggregateFunctionCall, over_clause) as u16, kind: FieldKind::NodeId, name: "over_clause" },
];
const FIELDS_CAST_EXPR: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(CastExpr, expr) as u16, kind: FieldKind::NodeId, name: "expr" },
    FieldDescriptor { offset: offset_of!(CastExpr, type_name) as u16, kind: FieldKind::Span, name: "type_name" },
];
const FIELDS_COLUMN_REF: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(ColumnRef, column) as u16, kind: FieldKind::Span, name: "column" },
    FieldDescriptor { offset: offset_of!(ColumnRef, table) as u16, kind: FieldKind::Span, name: "table" },
...
const FIELDS_SUBQUERY_EXPR: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(SubqueryExpr, select) as u16, kind: FieldKind::NodeId, name: "select" },
];
const FIELDS_EXISTS_EXPR: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(ExistsExpr, select) as u16, kind: FieldKind::NodeId, name: "select" },
];
const FIELDS_IN_EXPR: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(InExpr, negated) as u16, kind: FieldKind::Bool, name: "negated" },
    FieldDescriptor { offset: offset_of!(InExpr, operand) as u16, kind: FieldKind::NodeId, name: "operand" },
...
const FIELDS_BETWEEN_EXPR: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(BetweenExpr, negated) as u16, kind: FieldKind::Bool, name: "negated" },
    FieldDescriptor { offset: offset_of!(BetweenExpr, operand) as u16, kind: FieldKind::NodeId, name: "operand" },
    FieldDescriptor { offset: offset_of!(BetweenExpr, low) as u16, kind: FieldKind::NodeId, name: "low" },
    FieldDescriptor { offset: offset_of!(BetweenExpr, high) as u16, kind: FieldKind::NodeId, name: "high" },
];
const FIELDS_LIKE_EXPR: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(LikeExpr, negated) as u16, kind: FieldKind::Bool, name: "negated" },
    FieldDescriptor { offset: offset_of!(LikeExpr, operand) as u16, kind: FieldKind::NodeId, name: "operand" },
    FieldDescriptor { offset: offset_of!(LikeExpr, pattern) as u16, kind: FieldKind::NodeId, name: "pattern" },
    FieldDescriptor { offset: offset_of!(LikeExpr, escape) as u16, kind: FieldKind::NodeId, name: "escape" },
];
const FIELDS_CASE_EXPR: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(CaseExpr, operand) as u16, kind: FieldKind::NodeId, name: "operand" },
    FieldDescriptor { offset: offset_of!(CaseExpr, else_expr) as u16, kind: FieldKind::NodeId, name: "else_expr" },
    FieldDescriptor { offset: offset_of!(CaseExpr, whens) as u16, kind: FieldKind::NodeId, name: "whens" },
];
const FIELDS_CASE_WHEN: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(CaseWhen, when_expr) as u16, kind: FieldKind::NodeId, name: "when_expr" },
    FieldDescriptor { offset: offset_of!(CaseWhen, then_expr) as u16, kind: FieldKind::NodeId, name: "then_expr" },
];
...
const FIELDS_COLUMN_CONSTRAINT: &[FieldDescriptor] = &[
    ...
    FieldDescriptor { offset: offset_of!(ColumnConstraint, fk_clause) as u16, kind: FieldKind::NodeId, name: "fk_clause" },
];
const FIELDS_COLUMN_DEF: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(ColumnDef, column_name) as u16, kind: FieldKind::Span, name: "column_name" },
    FieldDescriptor { offset: offset_of!(ColumnDef, type_name) as u16, kind: FieldKind::Span, name: "type_name" },
...
const FIELDS_TABLE_CONSTRAINT: &[FieldDescriptor] = &[
    ...
    FieldDescriptor { offset: offset_of!(TableConstraint, fk_clause) as u16, kind: FieldKind::NodeId, name: "fk_clause" },
];
const FIELDS_CREATE_TABLE_STMT: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(CreateTableStmt, table_name) as u16, kind: FieldKind::Span, name: "table_name" },
...
const FIELDS_WITH_CLAUSE: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(WithClause, recursive) as u16, kind: FieldKind::Bool, name: "recursive" },
    FieldDescriptor { offset: offset_of!(WithClause, ctes) as u16, kind: FieldKind::NodeId, name: "ctes" },
    FieldDescriptor { offset: offset_of!(WithClause, select) as u16, kind: FieldKind::NodeId, name: "select" },
];
const FIELDS_DELETE_STMT: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(DeleteStmt, table) as u16, kind: FieldKind::NodeId, name: "table" },
    FieldDescriptor { offset: offset_of!(DeleteStmt, where_clause) as u16, kind: FieldKind::NodeId, name: "where_clause" },
];
const FIELDS_SET_CLAUSE: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(SetClause, column) as u16, kind: FieldKind::Span, name: "column" },
    FieldDescriptor { offset: offset_of!(SetClause, columns) as u16, kind: FieldKind::NodeId, name: "columns" },
...
const FIELDS_VARIABLE: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(Variable, source) as u16, kind: FieldKind::Span, name: "source" },
];
const FIELDS_COLLATE_EXPR: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(CollateExpr, expr) as u16, kind: FieldKind::NodeId, name: "expr" },
...
const FIELDS_QUALIFIED_NAME: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(QualifiedName, object_name) as u16, kind: FieldKind::Span, name: "object_name" },
...
const FIELDS_SELECT_STMT: &[FieldDescriptor] = &[
    ...
    FieldDescriptor { offset: offset_of!(SelectStmt, groupby) as u16, kind: FieldKind::NodeId, name: "groupby" },
    FieldDescriptor { offset: offset_of!(SelectStmt, having) as u16, kind: FieldKind::NodeId, name: "having" },
    FieldDescriptor { offset: offset_of!(SelectStmt, orderby) as u16, kind: FieldKind::NodeId, name: "orderby" },
    FieldDescriptor { offset: offset_of!(SelectStmt, limit_clause) as u16, kind: FieldKind::NodeId, name: "limit_clause" },
    FieldDescriptor { offset: offset_of!(SelectStmt, window_clause) as u16, kind: FieldKind::NodeId, name: "window_clause" },
];
...
const FIELDS_LIMIT_CLAUSE: &[FieldDescriptor] = &[
    ...
    FieldDescriptor { offset: offset_of!(LimitClause, offset) as u16, kind: FieldKind::NodeId, name: "offset" },
];
const FIELDS_TABLE_REF: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(TableRef, table_name) as u16, kind: FieldKind::Span, name: "table_name" },
    FieldDescriptor { offset: offset_of!(TableRef, schema) as u16, kind: FieldKind::Span, name: "schema" },
    FieldDescriptor { offset: offset_of!(TableRef, alias) as u16, kind: FieldKind::Span, name: "alias" },
];
const FIELDS_SUBQUERY_TABLE_SOURCE: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(SubqueryTableSource, select) as u16, kind: FieldKind::NodeId, name: "select" },
...
const FIELDS_JOIN_CLAUSE: &[FieldDescriptor] = &[
    ...
    FieldDescriptor { offset: offset_of!(JoinClause, using_columns) as u16, kind: FieldKind::NodeId, name: "using_columns" },
];
...
const FIELDS_CREATE_TRIGGER_STMT: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(CreateTriggerStmt, trigger_name) as u16, kind: FieldKind::Span, name: "trigger_name" },
    ...
    FieldDescriptor { offset: offset_of!(CreateTriggerStmt, body) as u16, kind: FieldKind::NodeId, name: "body" },
];
const FIELDS_CREATE_VIRTUAL_TABLE_STMT: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(CreateVirtualTableStmt, table_name) as u16, kind: FieldKind::Span, name: "table_name" },
    FieldDescriptor { offset: offset_of!(CreateVirtualTableStmt, schema) as u16, kind: FieldKind::Span, name: "schema" },
    FieldDescriptor { offset: offset_of!(CreateVirtualTableStmt, module_name) as u16, kind: FieldKind::Span, name: "module_name" },
    FieldDescriptor { offset: offset_of!(CreateVirtualTableStmt, if_not_exists) as u16, kind: FieldKind::Bool, name: "if_not_exists" },
    FieldDescriptor { offset: offset_of!(CreateVirtualTableStmt, module_args) as u16, kind: FieldKind::Span, name: "module_args" },
];
...
const FIELDS_ATTACH_STMT: &[FieldDescriptor] = &[
    ...
    FieldDescriptor { offset: offset_of!(AttachStmt, db_name) as u16, kind: FieldKind::NodeId, name: "db_name" },
    FieldDescriptor { offset: offset_of!(AttachStmt, key) as u16, kind: FieldKind::NodeId, name: "key" },
];
const FIELDS_DETACH_STMT: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(DetachStmt, db_name) as u16, kind: FieldKind::NodeId, name: "db_name" },
];
const FIELDS_VACUUM_STMT: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(VacuumStmt, schema) as u16, kind: FieldKind::Span, name: "schema" },
...
const FIELDS_CREATE_INDEX_STMT: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(CreateIndexStmt, index_name) as u16, kind: FieldKind::Span, name: "index_name" },
    FieldDescriptor { offset: offset_of!(CreateIndexStmt, schema) as u16, kind: FieldKind::Span, name: "schema" },
    FieldDescriptor { offset: offset_of!(CreateIndexStmt, table_name) as u16, kind: FieldKind::Span, name: "table_name" },
    FieldDescriptor { offset: offset_of!(CreateIndexStmt, is_unique) as u16, kind: FieldKind::Bool, name: "is_unique" },
    FieldDescriptor { offset: offset_of!(CreateIndexStmt, if_not_exists) as u16, kind: FieldKind::Bool, name: "if_not_exists" },
    FieldDescriptor { offset: offset_of!(CreateIndexStmt, columns) as u16, kind: FieldKind::NodeId, name: "columns" },
    FieldDescriptor { offset: offset_of!(CreateIndexStmt, where_clause) as u16, kind: FieldKind::NodeId, name: "where_clause" },
];
const FIELDS_CREATE_VIEW_STMT: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(CreateViewStmt, view_name) as u16, kind: FieldKind::Span, name: "view_name" },
    FieldDescriptor { offset: offset_of!(CreateViewStmt, schema) as u16, kind: FieldKind::Span, name: "schema" },
    FieldDescriptor { offset: offset_of!(CreateViewStmt, is_temp) as u16, kind: FieldKind::Bool, name: "is_temp" },
    FieldDescriptor { offset: offset_of!(CreateViewStmt, if_not_exists) as u16, kind: FieldKind::Bool, name: "if_not_exists" },
    FieldDescriptor { offset: offset_of!(CreateViewStmt, column_names) as u16, kind: FieldKind::NodeId, name: "column_names" },
    FieldDescriptor { offset: offset_of!(CreateViewStmt, select) as u16, kind: FieldKind::NodeId, name: "select" },
];
...
const FIELDS_WINDOW_DEF: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(WindowDef, base_window_name) as u16, kind: FieldKind::Span, name: "base_window_name" },
    FieldDescriptor { offset: offset_of!(WindowDef, partition_by) as u16, kind: FieldKind::NodeId, name: "partition_by" },
    FieldDescriptor { offset: offset_of!(WindowDef, orderby) as u16, kind: FieldKind::NodeId, name: "orderby" },
    FieldDescriptor { offset: offset_of!(WindowDef, frame) as u16, kind: FieldKind::NodeId, name: "frame" },
];
const FIELDS_NAMED_WINDOW_DEF: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(NamedWindowDef, window_name) as u16, kind: FieldKind::Span, name: "window_name" },
    FieldDescriptor { offset: offset_of!(NamedWindowDef, window_def) as u16, kind: FieldKind::NodeId, name: "window_def" },
];
const FIELDS_FILTER_OVER: &[FieldDescriptor] = &[
    FieldDescriptor { offset: offset_of!(FilterOver, filter_expr) as u16, kind: FieldKind::NodeId, name: "filter_expr" },
    FieldDescriptor { offset: offset_of!(FilterOver, over_def) as u16, kind: FieldKind::NodeId, name: "over_def" },
    FieldDescriptor { offset: offset_of!(FilterOver, over_name) as u16, kind: FieldKind::Span, name: "over_name" },
];

pub(crate) const FIELD_DESCRIPTORS: &[&[FieldDescriptor]] = &[
    &[], // NodeTag::Null
    FIELDS_AGGREGATE_FUNCTION_CALL, // NodeTag::AggregateFunctionCall
    FIELDS_CAST_EXPR, // NodeTag::CastExpr
    FIELDS_COLUMN_REF, // NodeTag::ColumnRef
    FIELDS_COMPOUND_SELECT, // NodeTag::CompoundSelect
    FIELDS_SUBQUERY_EXPR, // NodeTag::SubqueryExpr
    FIELDS_EXISTS_EXPR, // NodeTag::ExistsExpr
    FIELDS_IN_EXPR, // NodeTag::InExpr
    FIELDS_IS_EXPR, // NodeTag::IsExpr
    FIELDS_BETWEEN_EXPR, // NodeTag::BetweenExpr
    FIELDS_LIKE_EXPR, // NodeTag::LikeExpr
    FIELDS_CASE_EXPR, // NodeTag::CaseExpr
    FIELDS_CASE_WHEN, // NodeTag::CaseWhen
    &[], // NodeTag::CaseWhenList
    FIELDS_FOREIGN_KEY_CLAUSE, // NodeTag::ForeignKeyClause
    FIELDS_COLUMN_CONSTRAINT, // NodeTag::ColumnConstraint
    &[], // NodeTag::ColumnConstraintList
    FIELDS_COLUMN_DEF, // NodeTag::ColumnDef
    &[], // NodeTag::ColumnDefList
    FIELDS_TABLE_CONSTRAINT, // NodeTag::TableConstraint
    &[], // NodeTag::TableConstraintList
    FIELDS_CREATE_TABLE_STMT, // NodeTag::CreateTableStmt
    FIELDS_CTE_DEFINITION, // NodeTag::CteDefinition
    &[], // NodeTag::CteList
    FIELDS_WITH_CLAUSE, // NodeTag::WithClause
    FIELDS_DELETE_STMT, // NodeTag::DeleteStmt
    FIELDS_SET_CLAUSE, // NodeTag::SetClause
    &[], // NodeTag::SetClauseList
    FIELDS_UPDATE_STMT, // NodeTag::UpdateStmt
    FIELDS_INSERT_STMT, // NodeTag::InsertStmt
    FIELDS_BINARY_EXPR, // NodeTag::BinaryExpr
    FIELDS_UNARY_EXPR, // NodeTag::UnaryExpr
    FIELDS_LITERAL, // NodeTag::Literal
    &[], // NodeTag::ExprList
    FIELDS_FUNCTION_CALL, // NodeTag::FunctionCall
    FIELDS_VARIABLE, // NodeTag::Variable
    FIELDS_COLLATE_EXPR, // NodeTag::CollateExpr
    FIELDS_RAISE_EXPR, // NodeTag::RaiseExpr
    FIELDS_QUALIFIED_NAME, // NodeTag::QualifiedName
    FIELDS_DROP_STMT, // NodeTag::DropStmt
    FIELDS_ALTER_TABLE_STMT, // NodeTag::AlterTableStmt
    FIELDS_TRANSACTION_STMT, // NodeTag::TransactionStmt
    FIELDS_SAVEPOINT_STMT, // NodeTag::SavepointStmt
    FIELDS_RESULT_COLUMN, // NodeTag::ResultColumn
    &[], // NodeTag::ResultColumnList
    FIELDS_SELECT_STMT, // NodeTag::SelectStmt
    FIELDS_ORDERING_TERM, // NodeTag::OrderingTerm
    &[], // NodeTag::OrderByList
    FIELDS_LIMIT_CLAUSE, // NodeTag::LimitClause
    FIELDS_TABLE_REF, // NodeTag::TableRef
    FIELDS_SUBQUERY_TABLE_SOURCE, // NodeTag::SubqueryTableSource
    FIELDS_JOIN_CLAUSE, // NodeTag::JoinClause
    FIELDS_JOIN_PREFIX, // NodeTag::JoinPrefix
    FIELDS_TRIGGER_EVENT, // NodeTag::TriggerEvent
    &[], // NodeTag::TriggerCmdList
    FIELDS_CREATE_TRIGGER_STMT, // NodeTag::CreateTriggerStmt
    FIELDS_CREATE_VIRTUAL_TABLE_STMT, // NodeTag::CreateVirtualTableStmt
    FIELDS_PRAGMA_STMT, // NodeTag::PragmaStmt
    FIELDS_ANALYZE_STMT, // NodeTag::AnalyzeStmt
    FIELDS_ATTACH_STMT, // NodeTag::AttachStmt
    FIELDS_DETACH_STMT, // NodeTag::DetachStmt
    FIELDS_VACUUM_STMT, // NodeTag::VacuumStmt
    FIELDS_EXPLAIN_STMT, // NodeTag::ExplainStmt
    FIELDS_CREATE_INDEX_STMT, // NodeTag::CreateIndexStmt
    FIELDS_CREATE_VIEW_STMT, // NodeTag::CreateViewStmt
    &[], // NodeTag::ValuesRowList
    FIELDS_VALUES_CLAUSE, // NodeTag::ValuesClause
    FIELDS_FRAME_BOUND, // NodeTag::FrameBound
    FIELDS_FRAME_SPEC, // NodeTag::FrameSpec
    FIELDS_WINDOW_DEF, // NodeTag::WindowDef
    &[], // NodeTag::WindowDefList
    FIELDS_NAMED_WINDOW_DEF, // NodeTag::NamedWindowDef
