...
function ensureThemesRegistered() {
  ...
  monaco.editor.defineTheme("syntaqlite-dark", {
    ...
    rules: [
      ...
      {token: "variable", foreground: "d98f4e"},
      {token: "variable.sql", foreground: "d98f4e"},
      {token: "type", foreground: "7ba7d9"},
      {token: "type.sql", foreground: "7ba7d9"},
  ...
  monaco.editor.defineTheme("syntaqlite-light", {
    ...
    rules: [
      ...
      {token: "variable", foreground: "9b5f1b"},
      {token: "variable.sql", foreground: "9b5f1b"},
      {token: "type", foreground: "5f7db2"},
      {token: "type.sql", foreground: "5f7db2"},
