...
static const YYCODETYPE yyRuleInfoLhs[] = {
    ...
    193, /* (233) cmd ::= ALTER TABLE add_column_fullname ADD kwcolumn_opt
            columnname carglist */
    ...
    210, /* (256) oneselect ::= SELECT distinct selcollist from where_opt
    ...
    289, /* (302) trigger_decl ::= temp TRIGGER ifnotexists nm dbnm trigger_time
            trigger_event ON fullname foreach_clause when_clause */
    ...
    294, /* (320) trigger_cmd ::= UPDATE orconf trnm tridxby SET setlist from
            where_opt scanpt */
    294, /* (321) trigger_cmd ::= scanpt insert_cmd INTO trnm idlist_opt select
            upsert scanpt */
    ...
    193, /* (356) cmd ::= createkw uniqueflag INDEX ifnotexists nm dbnm ON nm LP
            sortlist RP where_opt */
    299, /* (357) uniqueflag ::= UNIQUE */
    299, /* (358) uniqueflag ::= */
    239, /* (359) ifnotexists ::= */
    239, /* (360) ifnotexists ::= IF NOT EXISTS */
    193, /* (361) cmd ::= createkw temp VIEW ifnotexists nm dbnm eidlist_opt AS
            select */
    ...
    306, /* (372) create_vtab ::= createkw VIRTUAL TABLE ifnotexists nm dbnm
            USING nm */
    ...
    318, /* (394) frame_opt ::= range_or_rows BETWEEN frame_bound_s AND
...
static const signed char yyRuleInfoNRhs[] = {
    ...
    -7, /* (233) cmd ::= ALTER TABLE add_column_fullname ADD kwcolumn_opt
           columnname carglist */
    ...
    -9, /* (256) oneselect ::= SELECT distinct selcollist from where_opt
           groupby_opt having_opt orderby_opt limit_opt */
    -10, /* (257) oneselect ::= SELECT distinct selcollist from where_opt
            groupby_opt having_opt window_clause orderby_opt limit_opt */
    ...
    -11, /* (302) trigger_decl ::= temp TRIGGER ifnotexists nm dbnm trigger_time
            trigger_event ON fullname foreach_clause when_clause */
    ...
    -9,  /* (320) trigger_cmd ::= UPDATE orconf trnm tridxby SET setlist from
            where_opt scanpt */
    -8,  /* (321) trigger_cmd ::= scanpt insert_cmd INTO trnm idlist_opt select
            upsert scanpt */
    ...
    -12, /* (356) cmd ::= createkw uniqueflag INDEX ifnotexists nm dbnm ON nm LP
            sortlist RP where_opt */
    -1,  /* (357) uniqueflag ::= UNIQUE */
    0,   /* (358) uniqueflag ::= */
    0,   /* (359) ifnotexists ::= */
    -3,  /* (360) ifnotexists ::= IF NOT EXISTS */
    -9,  /* (361) cmd ::= createkw temp VIEW ifnotexists nm dbnm eidlist_opt AS
            select */
    ...
    -8,  /* (372) create_vtab ::= createkw VIRTUAL TABLE ifnotexists nm dbnm
            USING nm */
    ...
    -6,  /* (394) frame_opt ::= range_or_rows BETWEEN frame_bound_s AND
            frame_bound_e frame_exclude_opt */
...
static YYACTIONTYPE yy_reduce(
  ...
  switch (yyruleno) {
    ...
    */
    ...
    case 254: /* select ::= selectnowith */
      yytestcase(yyruleno == 254);
    case 255: /* selectnowith ::= oneselect */
      yytestcase(yyruleno == 255);
    case 370: /* cmd ::= create_vtab */
      yytestcase(yyruleno == 370);
    case 396: /* frame_bound_s ::= frame_bound */
      yytestcase(yyruleno == 396);
    case 398: /* frame_bound_e ::= frame_bound */
      yytestcase(yyruleno == 398);
    case 409: /* filter_over ::= over_clause */
      yytestcase(yyruleno == 409);
      {
    ...
    case 270: /* from ::= FROM seltablist */
      yytestcase(yyruleno == 270);
    case 272: /* where_opt ::= WHERE expr */
      yytestcase(yyruleno == 272);
    case 276: /* having_opt ::= HAVING expr */
      yytestcase(yyruleno == 276);
    case 312: /* when_clause ::= WHEN expr */
      yytestcase(yyruleno == 312);
    case 348: /* key_opt ::= KEY expr */
      yytestcase(yyruleno == 348);
    case 351: /* vinto ::= INTO expr */
      yytestcase(yyruleno == 351);
    case 407: /* window_clause ::= WINDOW windowdefn_list */
    ...
    case 236: /* kwcolumn_opt ::= COLUMNKW */
      yytestcase(yyruleno == 236);
    case 354: /* explain ::= EXPLAIN */
      yytestcase(yyruleno == 354);
    case 357: /* uniqueflag ::= UNIQUE */
    ...
    case 403: /* frame_exclude_opt ::= EXCLUDE frame_exclude */
      yytestcase(yyruleno == 403);
      {
    ...
    case 247: /* trans_opt ::= TRANSACTION nm */
    ...
    case 323: /* trigger_cmd ::= scanpt select scanpt */
    ...
    case 329: /* nmnum ::= plus_num */
      yytestcase(yyruleno == 329);
    case 330: /* nmnum ::= nm */
      yytestcase(yyruleno == 330);
    case 331: /* nmnum ::= ON */
      yytestcase(yyruleno == 331);
    case 332: /* nmnum ::= DELETE */
      yytestcase(yyruleno == 332);
    case 333: /* nmnum ::= DEFAULT */
      yytestcase(yyruleno == 333);
    case 335: /* plus_num ::= INTEGER|FLOAT */
      yytestcase(yyruleno == 335);
    case 337: /* signed ::= plus_num */
      yytestcase(yyruleno == 337);
    case 338: /* signed ::= minus_num */
      yytestcase(yyruleno == 338);
    case 362: /* createkw ::= CREATE */
    ...
    {
      yymsp[0].minor.yy213 =
          synq_parse_error_node(pCtx, pCtx->error_offset, pCtx->error_length);
    } break;
    ...
    case 233: /* cmd ::= ALTER TABLE add_column_fullname ADD kwcolumn_opt
                 columnname carglist */
    {
    ...
    case 248: /* savepoint_opt ::= SAVEPOINT */
    ...
    case 256: /* oneselect ::= SELECT distinct selcollist from where_opt
                 groupby_opt having_opt orderby_opt limit_opt */
    {
    ...
    case 260: /* sclp ::= selcollist COMMA */
    {
      ...
      break;
    case 263: /* as ::= AS nm */
    case 334: /* plus_num ::= PLUS INTEGER|FLOAT */
    ...
    case 278: /* orderby_opt ::= ORDER BY sortlist */
    ...
    case 302: /* trigger_decl ::= temp TRIGGER ifnotexists nm dbnm trigger_time
                 trigger_event ON fullname foreach_clause when_clause */
    {
    ...
    case 373: /* vtabarglist ::= vtabarg */
      yytestcase(yyruleno == 373);
    case 374: /* vtabarglist ::= vtabarglist COMMA vtabarg */
      yytestcase(yyruleno == 374);
    case 376: /* vtabarg ::= vtabarg vtabargtoken */
      yytestcase(yyruleno == 376);
    case 377: /* vtabargtoken ::= ANY */
      yytestcase(yyruleno == 377);
    case 378: /* vtabargtoken ::= lp anylist RP */
      yytestcase(yyruleno == 378);
    case 379: /* lp ::= LP */
      yytestcase(yyruleno == 379);
    case 381: /* anylist ::= anylist LP anylist RP */
      yytestcase(yyruleno == 381);
    case 382: /* anylist ::= anylist ANY */
    ...
    case 319: /* tridxby ::= NOT INDEXED */
      yytestcase(yyruleno == 319);
      {
        // Not allowed in triggers, but grammar accepts
      }
      break;
    case 320: /* trigger_cmd ::= UPDATE orconf trnm tridxby SET setlist from
                 where_opt scanpt */
    {
      uint32_t tbl =
    ...
    case 321: /* trigger_cmd ::= scanpt insert_cmd INTO trnm idlist_opt select
                 upsert scanpt */
    {
      uint32_t tbl =
    ...
    case 327: /* cmd ::= PRAGMA nm dbnm EQ minus_num */
    ...
    case 328: /* cmd ::= PRAGMA nm dbnm LP minus_num RP */
    ...
    case 356: /* cmd ::= createkw uniqueflag INDEX ifnotexists nm dbnm ON nm LP
                 sortlist RP where_opt */
    {
    ...
    case 361: /* cmd ::= createkw temp VIEW ifnotexists nm dbnm eidlist_opt AS
                 select */
    {
    ...
    case 367: /* mvalues ::= mvalues COMMA LP nexprlist RP */
    ...
    case 369: /* oneselect ::= mvalues */
      yytestcase(yyruleno == 369);
      {
    ...
    case 371: /* cmd ::= create_vtab LP vtabarglist RP */
    {
      ...
      yymsp[-3].minor.yy213 = yylhsminor.yy213;
      break;
    case 372: /* create_vtab ::= createkw VIRTUAL TABLE ifnotexists nm dbnm
                 USING nm */
    {
      SyntaqliteSourceSpan tbl_name =
          yymsp[-2].minor.yy0.z ? synq_span(pCtx, yymsp[-2].minor.yy0)
    ...
    case 393: /* frame_opt ::= range_or_rows frame_bound_s frame_exclude_opt */
    {
      ...
      yymsp[-2].minor.yy213 = yylhsminor.yy213;
      break;
    case 394: /* frame_opt ::= range_or_rows BETWEEN frame_bound_s AND
                 frame_bound_e frame_exclude_opt */
    {
      yylhsminor.yy213 = synq_parse_frame_spec(
