...
//   #define SYNTAQLITE_CFLAG_OMIT_WINDOWFUNC

#ifdef SYNTAQLITE_SQLITE_CFLAGS
static const SyntaqliteCflags synq_pinned_cflags = {
#ifdef SYNTAQLITE_CFLAG_OMIT_ALTERTABLE
    .omit_altertable = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_ANALYZE
    .omit_analyze = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_ATTACH
    .omit_attach = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_AUTOINCREMENT
    .omit_autoincrement = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_CAST
    .omit_cast = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_COMPILEOPTION_DIAGS
    .omit_compileoption_diags = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_COMPOUND_SELECT
    .omit_compound_select = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_CTE
    .omit_cte = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_DATETIME_FUNCS
    .omit_datetime_funcs = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_EXPLAIN
    .omit_explain = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_FLOATING_POINT
    .omit_floating_point = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_FOREIGN_KEY
    .omit_foreign_key = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_GENERATED_COLUMNS
    .omit_generated_columns = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_JSON
    .omit_json = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_LOAD_EXTENSION
    .omit_load_extension = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_PRAGMA
    .omit_pragma = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_REINDEX
    .omit_reindex = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_RETURNING
    .omit_returning = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_SUBQUERY
    .omit_subquery = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_TEMPDB
    .omit_tempdb = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_TRIGGER
    .omit_trigger = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_VACUUM
    .omit_vacuum = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_VIEW
    .omit_view = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_VIRTUALTABLE
    .omit_virtualtable = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_OMIT_WINDOWFUNC
    .omit_windowfunc = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_BYTECODE_VTAB
    .enable_bytecode_vtab = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_CARRAY
    .enable_carray = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_DBPAGE_VTAB
    .enable_dbpage_vtab = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_DBSTAT_VTAB
    .enable_dbstat_vtab = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_FTS3
    .enable_fts3 = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_FTS4
    .enable_fts4 = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_FTS5
    .enable_fts5 = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_GEOPOLY
    .enable_geopoly = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_JSON1
    .enable_json1 = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_MATH_FUNCTIONS
    .enable_math_functions = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_OFFSET_SQL_FUNC
    .enable_offset_sql_func = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_ORDERED_SET_AGGREGATES
    .enable_ordered_set_aggregates = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_PERCENTILE
    .enable_percentile = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_RTREE
    .enable_rtree = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_STMTVTAB
    .enable_stmtvtab = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_ENABLE_UPDATE_DELETE_LIMIT
    .enable_update_delete_limit = 1,
#endif
#ifdef SYNTAQLITE_CFLAG_SOUNDEX
    .soundex = 1,
#endif
};
